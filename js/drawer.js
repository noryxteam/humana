...
(function () {
  ...
  var DRAWERS = {
    ...
    'clientes-servicos': {
      ...
      role: 'Mais de 500 projetos realizados',
      image: 'assets/images/sobre/card-servicos.jpg',
      imageAlt: 'Serviços de tradução e interpretação da HUMANA',
      lead: 'Na última década, a HUMANA prestou mais de 500 serviços de tradução e interpretação para empresas, instituições e profissionais em todo o Brasil.',
      intro: 'Aproximadamente 300 serviços correspondem a interpretação simultânea e consecutiva, e 200 a trabalhos de tradução técnica, jurídica e científica — sempre com foco em qualidade, prazos e confidencialidade.',
      meta: [
        { icon: 'handshake', label: 'Projetos', value: '500+ serviços' },
        { icon: 'headphones', label: 'Interpretação', value: '300+ serviços' },
        { icon: 'languages', label: 'Tradução', value: '200+ trabalhos' },
        { icon: 'building-2', label: 'Clientes', value: '200+ empresas' },
      ],
      trajectory: [
    ...
    tradutores: {
      ...
      lead: '39 tradutores profissionais habituais e um grupo de 97 intérpretes colaboradores compõem a rede da HUMANA.',
      ...
      meta: [
        { icon: 'users', label: 'Tradutores', value: '39 colaboradores' },
        { icon: 'headphones', label: 'Intérpretes', value: '97 colaboradores' },
    ...
    'quem-somos': {
      ...
      image: 'assets/images/sobre-nos-1.jpg',
    ...
    interpretacao: {
      ...
      trajectory: [
        'Mais de 300 serviços de interpretação realizados para instituições, empresas e eventos científicos.',
    ...
    traducao: {
      ...
      meta: [
        ...
        { icon: 'users', label: 'Equipe', value: '39 tradutores' },
    ...
    'historia-2026': {
      ...
      hideImage: true,
      lead: 'Mais de 500 projetos realizados e um compromisso renovado com pessoas e culturas — da Amazônia para o Brasil e para o mundo.',
      intro: 'Hoje, a HUMANA conta com dezenas de tradutores profissionais e quase cem intérpretes colaboradores, atuando em interpretação simultânea presencial e remota, tradução técnica e jurídica, e cursos formativos.',
      meta: [
        { icon: 'headphones', label: 'Interpretação', value: '308 serviços' },
        { icon: 'languages', label: 'Tradução', value: '182 trabalhos' },
        { icon: 'users', label: 'Equipe', value: '97 intérpretes' },
        { icon: 'award', label: 'Projetos', value: '500+ realizados' },
      ],
      trajectory: [
      ...
      principles: [
        { icon: 'headphones', title: 'Interpretação', text: '308 serviços de interpretação simultânea e consecutiva.' },
        { icon: 'languages', title: 'Tradução', text: '182 trabalhos de tradução técnica e jurídica.' },
        { icon: 'users', title: 'Colaboradores', text: '97 intérpretes colaboradores em todo o Brasil.' },
